...
def print_tournament_players(tournament: TournamentBase) -> None:
...
def print_tournament_teams(tournament: TeamTournamentBase) -> None:
    """Helper function to visualize tournament players."""
    uuid_dict = tournament.get_participant_dict()
    for uuid, team in uuid_dict.items():
        name = get_name_from_uuid(uuid, uuid_dict)
        print(f"{name}")
...
def print_pairings(pairings: FinalizedPairings, tournament: TournamentBase) -> None:
...
def print_round_result(round_result: FinalizedRoundResult, tournament: TournamentBase) -> None:
...
def print_team_pairing(team_pairing: FinalizedTeamPairing, tournament: TeamTournamentBase) -> None:
...
def print_team_game_result(team_game_result: FinalizedTeamGameResult, tournament: TeamTournamentBase) -> None:
